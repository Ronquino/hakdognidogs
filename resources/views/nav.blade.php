<nav class="navbar navbar-expand-lg bg-secondary mb-3 p-2">
    <div class="container-fluid">
      <a class="navbar-brand" id="s1" href="/"><h1><b>IPT PROJECT</b></h1></a>
      ...
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav ms-auto">
          ...
          @else
          <a class="nav-link text-white btn btn-outline-danger"  id="s1" href="/">Home</a>
          <a class="nav-link text-white btn btn-outline-danger" id="s1" href="/home">Posts</a>
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle text-white btn btn-outline-danger" id="s1" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
              Categories
            </a>
            <ul class="dropdown-menu">
              @foreach (App\Models\Category::whereHas('posts')->get()->sortBy('category') as $category)
          ...
          <a class="nav-link text-white btn btn-outline-danger" id="s1" href="/authors">Authors</a>
          <a class="nav-link text-white btn btn-outline-danger" id="s1" href="/login">Login</a> 
          <a class="nav-link text-white btn btn-outline-danger" id="s1" href="/register">Register</a>
